    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-accent text-bg hover:bg-accent/90": variant === "default",
            "border border-surface-mid bg-transparent shadow-sm hover:bg-surface hover:text-foreground": variant === "outline",
